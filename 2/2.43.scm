...
;; 2.42が T とすると 2.43は T * (n ** n) 的な
;; T * (n - 1 :4列目の分) * (n - 1 :3列目の分) * (n - 1 :2列目の分) * (n - 1 :1列目の分)
;; (starts from 1)
;; 2.42のorderはnのn乗? (1:4回+2:4回+3:4回+4:4回)
;; 2.43のorderは
;; (1:4回) * (2:4回*1:4回) * (3:4回*2:4回*1:4回) * (4:4回*3:4回*2:4回*1:4回)
;; n 階乗 ** n
